...
import { worldCountries, getNationalities, getCountryCodeFromNationality } from "@/lib/countries";
...
// Get nationalities list from centralized data
                            ...
                            <FormItem>
                              ...
                              <Select 
                                onValueChange={(value) => {
                                  ...
                                  // Auto-update country code when first passenger's nationality changes
                                  if (index === 0) {
                                    const newCode = getCountryCodeFromNationality(value);
                                    form.setValue("country_code", newCode);
                                  }
                                }} 
                                value={field.value}
                              >
